...
UIInterfaceOrientation CYInterfaceOrientation() {
    UIInterfaceOrientation orient = [UIApplication sharedApplication].statusBarOrientation;
    return orient;
}

CGRect CYScreenBounds() {
    CGRect bounds = [UIScreen mainScreen].bounds;
    if (UIInterfaceOrientationIsLandscape(CYInterfaceOrientation())) {
...
- (CGFloat)orientationWidth {
    return UIInterfaceOrientationIsLandscape(CYInterfaceOrientation())
